	...
	<div class="fs-row">
		<div class="fs-cell">
			<div class="js-swap media_gallery_inner" data-swap-target=".media_gallery_body" data-swap-group="media_gallery" data-swap-linked="media_gallery">
				...
				"0px": "<?php echo $acf['background'] ?>",
				"500px": "<?php echo $acf['background'] ?>",
				"740px": "<?php echo $acf['background'] ?>",
				"980px": "<?php echo $acf['background'] ?>",
				"1220px": "<?php echo $acf['background'] ?>"
				}}'></div>
				            	...
				            	<?php if ($acf_gallery['type'] == 'video'): ?>
						            <div class="media_gallery_item">
						                <figure class="media_gallery_item_figure">
						                    <img class="media_gallery_item_image" src="<?php echo tric_video_support::get_thumb_url($acf_gallery['video']); ?>" alt="image">
