				...
				<div class="topic_item_inner">
					<figure class="topic_figure">
						<?php if (isset($topic_rows['image'])) { ?>
							<a class="topic_figure_link" href="<?php echo esc_url($topic_rows['link_url']) ?>">
					...
					<div class="topic_wrapper">
						<header class="topic_header">
							<h3 class="topic_title">
								<a class="topic_title_link" href="<?php echo esc_url($topic_rows['link_url']) ?>">
						...
						<footer class="topic_footer">
							<a class="topic_link" href="<?php echo esc_url($topic_rows['link_url']) ?>">
